...
tk.Label(root, text="Enter inductance (e.g., '1000 uH'):").grid(row=2, column=0, padx=10, pady=10)
...
tk.Label(root, text="Enter capacitance (e.g., '1000 pF'):").grid(row=3, column=0, padx=10, pady=10)
